...
There are many other algorithms similar to Prim's, notably Kruskal's. This specific maze generator uses Prim's algorithm for several significant reasons.
- Prim's grows a minimum spanning tree (MST) locally, expanding from the frontier. This results in a maze with more short branches/dead ends. This is the type of maze that we are used to.
